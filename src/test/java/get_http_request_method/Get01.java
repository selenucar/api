...
// junit -> framework to make testing easy
...
public class Get01 {
    ...
    */
    ...
    public void get01(){
        ...
        Response response = given().when().get(url); //-> that code will send the request to the API
                                                     // I will get respond i have to put it in container
        response.prettyPrint(); // seeing response on console
        ...
        // In Soft Assertion, all codes will be executed and you will get report for all assertion
        response.then().assertThat().statusCode(200).contentType("application/json").statusLine("HTTP/1.1 200 OK");

        // How to print status code, status line, content type, on the console
        System.out.println("Status Code is "+ response.getStatusCode());
        System.out.println("Status Code is "+ response.getStatusLine());
        System.out.println("Status Code is "+ response.getContentType());
