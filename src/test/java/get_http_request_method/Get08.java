...
public class Get08 extends JsonPlaceHolderBaseUrl {
    ...
    /*
        ...
        Converting JSON data to Object --> De-Serialization
        from Object to JSON --> Serialization

        1) Java uses Objects and Primitives as data types, API uses XML, JSON atc.
